    ...
    void apply(Project project) {
        ...
        project.task('hello') {
            ...
            doLast {
                ...
                println '--------------------------------->' + project.rootProject.buildFile
            }
        }
        ...
        A_PushXmlToPDA("QiaoPai", project)


    }

    void A_PushXmlToPDA(def projectName, Project project) {
        ...
        Task deleteConfigurationDir = project.task("deleteConfigurationDir") {
            doLast {
        ...
        project.task("A_PushXmlToPDA", dependsOn: deleteConfigurationDir) {
            group = "PDA"
